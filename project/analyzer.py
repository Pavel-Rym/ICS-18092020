...
if start == 1:
  ...
  shedule = int(input("Якщо бажаєте побачити графік? \n Графік товарообігу - натисність 1 \n Графік продуктивності - натисніть 2 "))
  if shedule == 1:
    x = [1, 2, 3, 4]
    y1p = [43102, 52684, 68453, 7529]
    y1f = [44568, 51825, 68400, 7524]
    y2p = [11707, 15905, 14236, 1566]
    y2f = [10922, 16000, 14000, 1540]
    y3p = [5498, 6895, 7245, 797]
    y3f = [5650, 7000, 7300, 803]
    plt.plot(x, y1p, '--r', label = "Універсам №1, плановий")
    plt.plot(x, y1f, '-r', label = "Універсам №1, фактичний")
    plt.plot(x, y2p, '--b', label = "Галактон, плановий")
    plt.plot(x, y2f, '-b', label = "Галактон, фактичний")
    plt.plot(x, y3p, '--g', label = "Поляниця, плановий")
    plt.plot(x, y3f, '-g', label = "Поляниця, фактичний")
    plt.title("Графік товарообігу")
    plt.legend()
    plt.show()
    ...
    y3p = [274, 275, 315, 265]
    y3f = [313, 304, 317, 267]
    plt.plot(x, y1p, '--r', label = "Універсам №1, планова")
    plt.plot(x, y1f, '-r', label = "Універсам №1, фактична")
    plt.plot(x, y2p, '--b', label = "Галактон, планова")
    plt.plot(x, y2f, '-b', label = "Галактон, фактична")
    plt.plot(x, y3p, '--g', label = "Поляниця, планова")
    plt.plot(x, y3f, '-g', label = "Поляниця, фактична")
